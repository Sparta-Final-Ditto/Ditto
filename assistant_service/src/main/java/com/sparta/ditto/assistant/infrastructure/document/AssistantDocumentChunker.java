...
/** FAQ 문서를 Q&A 쌍 단위로 청킹 — 질문/답변 한 쌍이 청크 1개 */
@Component
public class AssistantDocumentChunker {

    private static final int FAQ_VERSION = 1;

    public Document chunk(FaqItem item) {
        ...
        String documentId = UUID.nameUUIDFromBytes(item.id().getBytes(StandardCharsets.UTF_8)).toString();

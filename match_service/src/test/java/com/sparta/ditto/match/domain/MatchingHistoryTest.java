...
class MatchingHistoryTest {
    ...
    void of_setsAllFieldsCorrectly() {
        ...
        MatchingHistory history = MatchingHistory.of(userId, matchedUserId, 0.9f, 0.85f, "FEMALE", false);
    ...
    void accept_changesStatusToAccepted() {
        ...
        assertThat(history.getStatus()).isEqualTo("ACCEPTED");
    }
    ...
    void reject_changesStatusToRejected() {
        ...
        assertThat(history.getStatus()).isEqualTo("REJECTED");
    }
}
